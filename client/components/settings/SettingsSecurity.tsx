...
const SettingsSecurity = () => {
  ...
  const [twoFactorMethod, setTwoFactorMethod] = React.useState<
    "authenticator" | "email"
  >("authenticator");
  ...
  return (
    <>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={user && user.tfa_state == "enabled"}
                  onCheckedChange={(checked) =>
                    checked ? handleInitiateTfa() : handleDisableTfa()
                  }
                />
              </div>
              <div className="flex items-center justify-between">
      ...
      <TfaDialog
        qrCode={tfaData?.qr_code}
        otpUri={tfaData?.otp_uri}
