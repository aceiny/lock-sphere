...
export default function GeneratorPage() {
  ...
  const [strength, setStrength] = React.useState<keyof typeof strengthColors>("medium")
          ...
          <CardContent className="space-y-6">
            <div className="relative">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="outline" size="icon" onClick={copyPassword} className="relative">
                  <motion.div animate={copied ? { scale: 0 } : { scale: 1 }} transition={{ duration: 0.2 }}>
                ...
                <Button variant="outline" size="icon" onClick={generatePassword} className="relative overflow-hidden">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative pt-1">
                  <Slider value={length} max={32} min={8} step={1} onValueChange={setLength} className="z-10" />
                  <div className="absolute inset-0 flex items-center">
                    <div className={`h-2 w-full rounded-full ${strengthColors[strength]} opacity-20`} />
                  </div>
                </div>
              </div>
